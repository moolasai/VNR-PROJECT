<%@ Page Title="" Language="C#" MasterPageFile="~/Student.Master" AutoEventWireup="true" CodeBehind="edit.aspx.cs" Inherits="login_assignment.edit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <table id="customers">
        ...
        <tr>
            <td>
                <asp:Button ID="btnsave" runat="server" Text="Update Data" 
